...
\usepackage[scale=0.75, bottom=0.25cm, top=0.75cm]{geometry} % Reduce document margins to fit content (vary as needed!)
...
\cvitem{Beschreibung}{Design, Entwicklung und Erprobung eines interaktiven Cache Simulations-Spiels unter Einsatz von Gamification für die universitäre Lehre im Bereich Rechnerarchitektur.}

\cvitem{Verwendete Technologien}{Programmiersprache \textbf{GDScript} (sehr ähnlich zu Python), Game Engine Godot, Versionskontrolle mit \textbf{git / GitHub}, \comment{akademisches Schreiben mit}\LaTeX, Organisation mit Kanban Board}
