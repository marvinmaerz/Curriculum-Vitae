...
\cvitem{Machine Learning \& AI}{\textit{Deep Learning}: angewandte Übungen (siehe GitHub) mit \textbf{Python}, Numpy \& \textbf{PyTorch}; \textit{Künstliche Intelligenz I \& II} (2,0 \& 2,3): breit gefächerte Grundlagen und Methoden von symbolic bis statistical/sub-symbolic AI}
...
\cvlistitem{Musikproduktion \& DJing}

\cvlistitem{Fotografie \& Design}
